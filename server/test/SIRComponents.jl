...
DAYS_W_IMM_EXPECTED_VALUE = DAYS_W_IMM_VALUE
DAYS_INFECTED_ID = "2"
DAYS_INFECTED_NAME = "daysInfected"
DAYS_INFECTED_VALUE = "11"
DAYS_INFECTED_EXPECTED_VALUE = "11.0"
INITIAL_POP_ID = "3"
INITIAL_POP_NAME = "initialPop"
INITIAL_POP_VALUE = "1000000.0"
INITIAL_POP_EXPECTED_VALUE = INITIAL_POP_VALUE
START_TIME_ID = "444"
START_TIME_NAME = "startTime"
START_TIME_VALUE = "0"
START_TIME_EXPECTED_VALUE = "0.0"
STOP_TIME_ID = "555"
STOP_TIME_NAME = "stopTime"
STOP_TIME_VALUE = "100.0"
...
S_STOCK_ID = "6"
S_STOCK_NAME = "S"
S_INIT_VALUE = "initialPop - 1"
S_EXPECTED_VALUE = "params.initialPop - 1.0"
I_STOCK_ID = "7"
I_STOCK_NAME = "I"
I_INIT_VALUE = "1"
I_EXPECTED_VALUE = "1.0"
R_STOCK_ID = "8"
R_STOCK_NAME = "R"
R_INIT_VALUE = "0.0"
R_EXPECTED_VALUE = "0.0"

# var
INFECTION_RATE_VAR_ID = "9"
INFECTION_RATE_VAR_NAME = "infectionRate"
INFECTION_RATE_VAR_EQUATION = "$(I_STOCK_NAME)/$(TOTAL_POP_NAME)"
INFECTION_RATE_EXPECTED_EQUATION = "u.$(I_STOCK_NAME)/uN.$(TOTAL_POP_NAME)(u,t)"

# flows
BIRTH_ID = "10"
BIRTH_NAME = "birth"
BIRTH_EQUATION = "100"
BIRTH_EXPECTED_EQUATION = "100.0"
INF_ID = "11"
INF_NAME = "newInfection"
INF_EQUATION = "$(S_STOCK_NAME) * $(I_STOCK_NAME) / $(TOTAL_POP_NAME)"
INF_EXPECTED_EQUATION =
    "u.$(S_STOCK_NAME) * u.$(I_STOCK_NAME) / uN.$(TOTAL_POP_NAME)(u,t)"
REC_ID = "12"
REC_NAME = "newRecovery"
REC_EQUATION = "$(I_STOCK_NAME)/$(DAYS_INFECTED_NAME)"
REC_EXPECTED_EQUATION = "u.$(I_STOCK_NAME)/p.$(DAYS_INFECTED_NAME)"
WANIMM_ID = "13"
WANIMM_NAME = "waningImmunity"
WANIMM_EQUATION = "$(R_STOCK_NAME)/$(DAYS_W_IMM_NAME)"
WANIMM_EXPECTED_EQUATION = "u.$(R_STOCK_NAME)/p.$(DAYS_W_IMM_NAME)"
