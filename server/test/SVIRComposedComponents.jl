...
VAX_EFFECTIVENESS_NAME = "vaccinationEffectiveness"
...
PCT_VAXED_EXPECTED_EQUATION = PCT_VAXED_VAR_EQUATION

# extra flows
VACCINATION_ID = "004"
VACCINATION_NAME = "vaccination"
VACCINATION_EQUATION = "$(S_STOCK_NAME) * $(VAX_RATE_NAME)"
VACCINATION_EXPECTED_EQUATION = VACCINATION_EQUATION
VAXINFECTION_ID = "005"
...
VAXINFECTION_EXPECTED_EQUATION = (
    "$(V_STOCK_NAME) * (1.0-$(VAX_EFFECTIVENESS_NAME)) * "
    * "$(I_STOCK_NAME) / $(TOTAL_POP_NAME)"
)
