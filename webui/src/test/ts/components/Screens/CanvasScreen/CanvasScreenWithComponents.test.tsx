...
export default class CanvasScreenWithComponents extends CanvasScreenTest {
    ...
    public describeTests(): void {
        ...
        describe("Deletions", () => {
            ...
            test("Should successfully cascade-delete 1 layer of dependent components", async () => {
                ...
                expect(mockArgs[0]).toBe(CanvasScreenTest.AN_ID);
        ...
        describe("Edit Box", () => {
            ...
            test("Should notify Firebase when Edit Box invokes callback", async () => {
                ...
                expect(this.firebaseDataModel?.updateComponent)
                    .toHaveBeenLastCalledWith(CanvasScreenTest.AN_ID, updatedComponent);
            });
        });
...
new CanvasScreenWithComponents().describeTests();
