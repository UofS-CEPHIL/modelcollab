...
export interface Props<Component extends FirebaseComponent> extends BaseProps {
    initialComponent: Component;
    handleSave: (c: Component) => void;
    handleCancel: () => void;
}

export interface State<Component extends FirebaseComponent> extends BaseState {
    component: Component;
}

export abstract class ExtensibleEditBox
    <
        Component extends FirebaseComponent,
...
export default abstract class EditBox<Component extends FirebaseComponent>
